...
HD_PWD='/home/animandal/vivado_projects/rvx_cam/rvx_cam.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rvx_cam_nexys.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rvx_cam_nexys.tcl
