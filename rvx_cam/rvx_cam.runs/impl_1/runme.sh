...
HD_PWD='/home/animandal/vivado_projects/rvx_cam/rvx_cam.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rvx_cam_nexys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rvx_cam_nexys.tcl -notrace
