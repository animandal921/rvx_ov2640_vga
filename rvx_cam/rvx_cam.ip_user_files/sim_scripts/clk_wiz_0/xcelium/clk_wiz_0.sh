...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" +incdir+"../../../../ov2640_nexys.gen/sources_1/ip/clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" +incdir+"../../../../ov2640_nexys.gen/sources_1/ip/clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/animandal/vivado_projects/rvx_cam/rvx_cam.cache/compile_simlib/xcelium"
  fi
