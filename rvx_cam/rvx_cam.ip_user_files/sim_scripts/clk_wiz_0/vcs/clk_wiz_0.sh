...
#
# Script generated by Vivado on Mon Mar 30 01:07:00 IST 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" +incdir+"../../../../ov2640_nexys.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" +incdir+"../../../../ov2640_nexys.gen/sources_1/ip/clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/animandal/vivado_projects/rvx_cam/rvx_cam.cache/compile_simlib/vcs"
  fi
